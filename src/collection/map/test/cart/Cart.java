...
public class Cart {
    ...
    public void add(Product product, int addQuantity) {
        Integer existingQunatity = cartMap.getOrDefault(product, 0);
        cartMap.put(product, existingQunatity + addQuantity);
    }
    ...
    public void printAll() {
        ...
        for (Map.Entry<Product, Integer> entry : cartMap.entrySet()) {
            System.out.println("상품 : " + entry.getKey() + ", 수령 : " + entry.getValue());
        }
    }
}
